...
$database = mysql_connect("localhost", "timber", "zKwTtBYw");
mysql_select_db("timberbugs");
...
$result = mysql_list_tables ("timberbugs");
...
<center>
<form name=ff method=post action="download_bug_admin.php">
...
{
?>
<!--td bgcolor="#e3e3e3">UPDATE / DELETE</td-->	
<?
}
?>
</tr>
...
{
?>
<td><input name=<? echo "\"$name[$i]".$j."\""; ?> type="text" id=<? echo "\"$name[$i]\""; ?> value=<? $currRow=$currTable[$j]; echo "\"" . htmlspecialchars(urldecode($currRow[$i])) . "\""; ?>></td>
