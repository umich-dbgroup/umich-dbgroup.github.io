            ...
            else
            {
                ...
                echo "<TABLE CELLSPACING = 1 CELLPADDING = 2 ALIGN = \"CENTER\">
                        ...
                        <TR>
                            ...
                            <TD WIDTH = \"50%\"><A HREF = \"Timber2.1.zip\">Timber2.1.zip</A><IMG SRC = \"new.gif\" /></TD>
			</TR>
			<TR>
                            <TD WIDTH = \"50%\">&nbsp;</TD>
                            <TD WIDTH = \"50%\"><A HREF = \"Timber1.0.zip\">Timber1.0.zip</A></TD>
                        </TR>
                        <TR>
                            <TD WIDTH = \"50%\">XQuery Parser Project</TD>
                            <TD WIDTH = \"50%\"><A HREF = \"XQueryParser.zip\">XQueryParser.zip</A></TD>
                        </TR>
                        <TR>
                            <TD WIDTH = \"50%\">TIMBER Web Interface</TD>
                            <TD WIDTH = \"50%\"><A HREF = \"TimberWebInterface.zip\">TimberWebInterface.zip</A></TD>
                        </TR>
                        <TR>
                            <TD WIDTH = \"50%\">Help</TD>
                            <TD WIDTH = \"50%\"><A HREF = \"README.txt\">README</A></TD>
                        </TR>
                        <TR>
                            <TD COLSPAN = 2>&nbsp;</TD>
                        </TR>
...
?>
                <HR />
                <P ALIGN = "RIGHT">
                <IMG SRC = "email.gif" /><I><FONT SIZE = 2><BR>Page last modified on 30/Aug/07</FONT></I>
		</P>
            </TD>
        </TR>
    </TABLE>
