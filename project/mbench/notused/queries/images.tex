...
$\sum_{l=2}^{l=16} (n_l) \times (1/f_{l-1}) \approx 1/2$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\sum_{l=1}^{16}(N_{l}/64)^2 \approx 350,000$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\sum_{l=1}^{16}(N_{l}/16)^2 \approx 5,600,000$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
${16\choose n} \times(1/16)^n\times(15/16)^{16-n}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_inline388}%
$1 - P_0(``{\sf oneB1}'') - P_1(``{\sf oneB1}'')$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
